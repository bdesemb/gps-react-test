package be.infrabel.gps.repository;

import be.infrabel.gps.JhipsterGpsReactApp;
import be.infrabel.gps.config.Constants;
import be.infrabel.gps.config.TestSecurityConfiguration;
import be.infrabel.gps.config.audit.AuditEventConverter;
import be.infrabel.gps.domain.PersistentAuditEvent;
...
import static be.infrabel.gps.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
